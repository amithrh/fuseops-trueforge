...
Enter Live harness, reset the incident, paste the prepared prompt, and run it.
...
If model latency threatens the recording, use Demo replay and say: “This clearly labeled product replay reproduces the same locally tested states without claiming a model is running.”
